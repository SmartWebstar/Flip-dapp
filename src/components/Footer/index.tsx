    ...
    <Box sx={{ display: "flex" }}>
      <Box sx={{ mt: desktop ? "" : "1rem", ml: desktop ? "" : "15%" }}>
        <Box sx={{ display: "flex", justifyContent: desktop ? "" : "center" }}>
          <img src={foot1} width={desktop ? "2%" : "6%"} alt="" />
          <FontAwesomeIcon className="icon-1" icon={faTwitter} />
          <FontAwesomeIcon className="icon-2" icon={faDiscord} />
          <img src={foot2} width={desktop ? "2%" : "6%"} alt="" />
        </Box>
        <Typography
          className={mode === "dark" ? "text-foot dark" : "text-foot"}
          sx={{ textAlign: desktop ? "left" : "center" }}
        >
          Solana Network: 2106 TPS
        </Typography>
      </Box>
      <img src={chat} width={desktop ? "5%" : "15%"} className="chat" alt="" />
    </Box>
  );
};
